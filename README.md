...
1. If you were to describe semantic HTML to the next cohort of students, what would you say?
   -- Semantic HTML elements improves SEO for the site and makes the site more accessible to everyone. Also it helps make your code more legible for developers that come after you.

2. Name two big differences between `display: block;` and `display: inline;`.
   -- Block elements start a new line and follows the box model. Inline elements stay within the line and will ignore height and width properties.
...
5. Explain why git is valuable to a team of developers.
   -- Version control, and the ability to have collaboraters review your code before merging into the main branch.
